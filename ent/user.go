...
type User struct {
	...
	// CoachID holds the value of the "coach_id" field.
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case user.FieldID, user.FieldPassword, user.FieldCoachID, user.FieldCourseID:
...
func (_m *User) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", _m.CoachID))
	builder.WriteString(", ")
